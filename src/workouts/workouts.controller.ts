...
export class WorkoutsController {
  ...
  @ApiResponse({
    status: 200,
    description:
      'Return a message saying the workout was created and an Object with the data of the workout',
  })
  @ApiBadRequestResponse({
    description:
      'Return a message saying if something wrong happened while creating a workout',
  })
  @ApiUnauthorizedResponse({
  ...
  @ApiBadRequestResponse({
    description:
      'Return a message saying if something wrong happened while showing all workouts',
  })
  ...
  @ApiBadRequestResponse({
    description:
      'Return a message saying if something wrong happened while showing user workouts',
  })
  @ApiUnauthorizedResponse({
    description: 'Return a message saying if the user is not authorized',
  })
  ...
  @ApiBadRequestResponse({
    description:
      'Return a message saying if something wrong happened while showing the schedule selected workouts',
  })
  ...
  @ApiBadRequestResponse({
    description:
      'Return a message saying if something wrong happened while deleting a workout',
  })
  @ApiUnauthorizedResponse({
    description: 'Return a message saying if the user is not authorized',
  })
  ...
  @ApiResponse({
    status: 200,
    description:
      'Return a message saying the workout was modified an Object with the data of the workout',
  })
  @ApiBadRequestResponse({
    description:
      'Return a message saying if something wrong happened while modifying a workout',
  })
  @ApiUnauthorizedResponse({
    description: 'Return a message saying if the user is not authorized',
  })
  async modifyWorkoutById(
    ...
    const response = await this.workoutsService.modifyWorkout(
      workoutId,
      workout,
    );
    res.status(HttpStatus.OK).send(response);
